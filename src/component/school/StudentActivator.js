...
import { getAuthSchool, studentActivator } from '../../redux/reducer/schoolSlice';
     ...
     const handleFormSubmit = async (values, { resetForm })  => {
          ...
          const anonymousRequest = {
              isActive:  values.isActive
                    ...
                    try {
                      const body = await dispatch(studentActivator({id: state.id, activatorStatus: anonymousRequest})).unwrap();
                      console.log(body);
             ...
             <Formik
                ...
                {({
                 ...
                 <section class={style.container__brand}>
                  ...
                  {/*Card Header*/}
                <p className={style['form-header']}>Close Students Account</p>
                      ...
                      <div style={{width: '100%', display: 'flex', justifyContent: 'center'}}>
                       ...
                       <FormControl sx={{ m: 1, minWidth: "100%"}}>
                         <InputLabel  sx={{ fontSize: 18 }} >Select Activation Type</InputLabel>
                           <Select
                           label="Activator"
                           name='isActive'
                           variant='filled'
                         ...
                         >
                                 ...
                                 <MenuItem  sx={{ fontSize: 18 }} value="Activated">Activated</MenuItem>
                                 <MenuItem  sx={{ fontSize: 18 }} value="Deactivate">Deactivate</MenuItem>
                
                         </Select>
                         <FormHelperText sx={{ fontSize: 15 }}>{touched.isActive?.name && errors.isActive?.name}</FormHelperText>
                       </FormControl>
...
export default StudentActivator;
