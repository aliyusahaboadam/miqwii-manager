...
const togglePasswordVisibility = () => {
     ...
     const handleFormSubmit = async (values, { resetForm })  => {
                   ...
                   console.log(values.password);
                    try {
                      const body = await dispatch(sendPasswordReset({resetToken: resetToken, password: values.password})).unwrap();
                      console.log(body);
...
<TextField
    ...
    />
             ...
             <button  disabled={isSubmitting}  type="submit" onClick={handleSubmit} className={[style['btn'], style['btn--block'], style['btn--primary']].join(' ')}>{isSubmitting ? 'Resetting...' : 'Reset'}</button>
            

          <div className={style['form-link--container']}>
             <span className={style['form-link']} > Already Have an Account:  <a className={style['link__register']} href="#/school/login">Login</a></span>
          </div>
