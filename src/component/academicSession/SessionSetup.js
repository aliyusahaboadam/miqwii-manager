...
onClick={(e) => e.stopPropagation()}>Profile</a>
                                ...
                                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                  <TableHead>
                                    <TableRow>
                                      ...
                                      <StyledTableCell align="left">Set Current Term&nbsp;</StyledTableCell>
                                    </TableRow>
                                  </TableHead>
                                  <TableBody>
                                  {(rowsPerPage > 0
  ...
  control={
 <Checkbox
  checked={values.selectedId === row.id}
  onChange={() => setFieldValue("selectedId", row.id)}
...
label=" Current Session" 
  ...
  sx={{ 
    '& .MuiFormControlLabel-label': {
      fontSize: '18px', // 🔍 Change this to your desired size
...
/>
            ...
            <div class={dashboard['card_body']}>
                 ...
                 <div class={dashboard['card--small-head']}>
                  <button disabled={isSubmitting}  type="submit" onClick={handleSubmit}  className={[dashboard['btn'], dashboard['btn--block'], dashboard['btn--green']].join(' ')}>Set Term</button>
                 </div>
