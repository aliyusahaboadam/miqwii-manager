...
import { getSchoolById, updateDomainName } from '../../redux/reducer/schoolSlice';
...
const UpdateDomainName = () => {
  ...
  const schoolRegistrationSchema = object({
    domainName: string().max(50, "Domain Name must not exceed 50 characters")
  ...
  useEffect(() => {
   ...
   const   fetchSchool = async () => {
     ...
     const handleFormSubmit = async (values, { resetForm })  => {
                    ...
                    try {
                      const body = await dispatch(updateDomainName({id: state.id, domainName: values.domainName})).unwrap();
                      console.log(body);
             ...
             <Formik
                ...
                {({
                 ...
                 <section class={style.container__brand}>
                  ...
                  {/*Card Header*/}
                <p className={style['form-header']}>Update Domain Name</p>
