...
const [state, setState ] = useState({
  ...
  useEffect(() => {
   ...
   const   fetchStudent = async () => {
        try {
          setIsLoading(true)
          await  dispatch(getAuthenticatedTeacherById()).unwrap().then((result) => {
...
{/*Card Header*/}
<p className={style['form-header']}>Teacher Details</p>


<div class={dashboard['card--details']}>
<span>Reg. No:</span>    {state.regNo}
</div>
