...
const DeleteClass = () => {
  ...
  const classDeleteSchema = object({
...
const handleClose = (event, reason) => {
  ...
  const handleFormSubmit = async (values, { resetForm })  => {
      console.log(values);
         ...
         try {
         const result = await dispatch(deleteClass(values.name)).unwrap();
          console.log(result);
  ...
  return (
   ...
   <SignInContainer>
             ...
             <Formik
                    ...
                    validationSchema={classDeleteSchema}
                ...
                {({
                 ...
                 <section class={style.container__brand}>
                  ...
                  {/*Card Header*/}
                <p className={style['form-header']}>Remove Class</p>
   ...
   <TextField
       ...
       />
             ...
             <button  disabled={isSubmitting}  type="submit" onClick={handleSubmit} className={[style['btn'], style['btn--block'], style['btn--primary']].join(' ')}>{isSubmitting ? 'Submitting...' : 'Delete Class'}</button>
             <span className={style['form-link']} >Note: This action will include student in the class</span>
             </Card>
