             ...
             <Formik
                ...
                {({
                 ...
                 <section class={style.container__brand}>
                  ...
                  {/*Card Header*/}
                <p className={style['form-header']}>Add Nursery Classes</p>
    ...
    {/*Input Field*/}
     ...
     <FormControl sx={{ m: 1, minWidth: "100%"}}>
        ...
        >
                ...
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR1A"}>{"NUR1A"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR1B"}>{"NUR1B"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR1C"}>{"NUR1C"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR1D"}>{"NUR1D"}</MenuItem>

                <MenuItem  sx={{ fontSize: 18 }} value={"NUR2A"}>{"NUR2A"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR2B"}>{"NUR2B"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR2C"}>{"NUR2C"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR2D"}>{"NUR2D"}</MenuItem>
                
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR3A"}>{"NUR3A"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR3B"}>{"NUR3B"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR3C"}>{"NUR3C"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"NUR3D"}>{"NUR3D"}</MenuItem>
        ...
        <FormHelperText sx={{ fontSize: 15 }}>{touched.name && errors.name}</FormHelperText>
             ...
             <button  disabled={isSubmitting}  type="submit" onClick={handleSubmit} className={[style['btn'], style['btn--block'], style['btn--primary']].join(' ')}>{isSubmitting ? 'Submitting...' : 'Add Primary Class'}</button>
             <span className={style['form-link']} >Let us know your Primary classes</span>
             </Card>
