             ...
             <Formik
                ...
                {({
                 ...
                 <section class={style.container__brand}>
                  ...
                  {/*Card Header*/}
                <p className={style['form-header']}>Add Primary Classes</p>
    ...
    {/*Input Field*/}
     ...
     <FormControl sx={{ m: 1, minWidth: "100%"}}>
        ...
        >
                ...
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI1A"}>{"PRI1A"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI1B"}>{"PRI1B"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI1C"}>{"PRI1C"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI1D"}>{"PRI1D"}</MenuItem>

                <MenuItem  sx={{ fontSize: 18 }} value={"PRI2A"}>{"PRI2A"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI2B"}>{"PRI2B"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI2C"}>{"PRI2C"}</MenuItem>
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI2D"}>{"PRI2D"}</MenuItem>
                
                <MenuItem  sx={{ fontSize: 18 }} value={"PRI3A"}>{"PRI3A"}</MenuItem>
