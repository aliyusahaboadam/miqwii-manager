...
const fetchData = async () => {
  try {
    ...
    await Promise.all([
      dispatch(getPrefixClassnameAndBasicDetails('S')).unwrap(),
...
onClick={(e) => e.stopPropagation()}>Profile</a>
  ...
  <div className={dashboard['secondary--container']}>
            ...
            <div class={dashboard['card_body']}>
                ...
                <button onClick={navigateToAddSSSClasses}  className={[dashboard['btn'], dashboard['btn--block'], dashboard['btn--primary']].join(' ')}>Add SSS Class</button>
