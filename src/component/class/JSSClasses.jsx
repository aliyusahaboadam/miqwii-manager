...
import { deleteClass, getClassCount, getClassCountSpecific, getPrefixClassnameAndBasicDetails } from '../../redux/reducer/classSlice';
 ...
 const [rowsPerPage, setRowsPerPage] = React.useState(100);
  ...
  const rows = Array.isArray(classNamesSpecific) ? classNamesSpecific : [];
      ...
      const handleDelete = async (id)  => {
        ...
        const result = await dispatch(deleteClass(id)).unwrap();
      };
    ...
    const navigateToAddJSSClasses = () => {
      navigate('/class/add-jss-class')
    }
...
onClick={(e) => e.stopPropagation()}>Profile</a>
 ...
 <div className={dashboard['secondary--container']}>
          ...
          <span class={[dashboard['badge'], dashboard['']].join(' ')}>{classCountSpecific}</span>
          ...
          <span class={[dashboard['badge'], dashboard['']].join(' ')}>{classCount}</span>
          ...
          <div class={dashboard['card_body']}>
              ...
              <button onClick={navigateToAddJSSClasses}  className={[dashboard['btn'], dashboard['btn--block'], dashboard['btn--primary']].join(' ')}>Add JSS Class</button>
