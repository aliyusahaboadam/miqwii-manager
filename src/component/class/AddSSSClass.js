...
const handleClose = (event, reason) => {
  ...
  //  if (classNames.inludes(className)) 
  //    return <div className={dashboard['card--notice']} style={{display: 'flex', justifyItems: 'center', alignItems: 'center'}}>
                ...
                <Formik
                   ...
                   {({
                    ...
                    <section class={style.container__brand}>
                     ...
                     {/*Card Header*/}
                   <p className={style['form-header']}>Add SSS Classes</p>
       ...
       {/*Input Field*/}
        ...
        <FormControl sx={{ m: 1, minWidth: "100%"}}>
           ...
           >
                   ...
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS1A"}>{"SSS1A"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS1B"}>{"SSS1B"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS1C"}>{"SSS1C"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS1D"}>{"SSS1D"}</MenuItem>
   
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS2A"}>{"SSS2A"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS2B"}>{"SSS2B"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS2C"}>{"SSS2C"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS2D"}>{"SSS2D"}</MenuItem>
                   
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS3A"}>{"SSS3A"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS3B"}>{"SSS3B"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS3C"}>{"SSS3C"}</MenuItem>
                   <MenuItem  sx={{ fontSize: 18 }} value={"SSS3D"}>{"SSS3D"}</MenuItem>
           ...
           <FormHelperText sx={{ fontSize: 15 }}>{touched.name && errors.name}</FormHelperText>
                ...
                <button  disabled={isSubmitting}  type="submit" onClick={handleSubmit} className={[style['btn'], style['btn--block'], style['btn--primary']].join(' ')}>{isSubmitting ? 'Submitting...' : 'Add SSS Class'}</button>
                <span className={style['form-link']} >Let us know your SSS classes</span>
                </Card>
